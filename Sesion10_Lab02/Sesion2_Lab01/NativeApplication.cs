...
namespace Sesion2_Lab01 {
    public class NativeApplication {
        ...
        public NativeApplication() {
            ...
            mShaderBitmapFontProgram = new ShaderBitmapFontTextureProgram(mDevice);
            ...
            NTexture2D texture = new NTexture2D(mDevice);
            ...
            mSoundInstance = new NSoundInstance(mSoundDevice);
            mSoundInstance.BindDataBuffer(mSoundNode, 2);
            mSoundInstance.Play(OnFinishSound);
